...
export const APPLY_GUIDES: Record<string, ApplyGuide> = {
  funeral: {
    ...
    steps: [
      {
        title: "先辦理死亡登記",
        detail: "向戶籍地戶政事務所辦理，取得除戶證明。這是後續所有申請的前置文件。",
        isPrerequisite: true,
      },
      {
        title: "確認過世者的投保身分與投保單位",
        detail: "不同保險別由不同機關受理。可透過 MyData 調閱投保資料確認。",
      },
      {
        title: "備齊申請書與證明文件",
        detail: "申請書可於勞保局網站下載，或使用本站的預填版本。",
      },
      {
        title: "選擇送件方式",
        detail: "臨櫃至勞保局各地辦事處、郵寄、或以自然人憑證線上申辦。",
      },
      {
        title: "等待審核與撥款",
        detail: "審核通過後匯入指定帳戶。若文件不全，勞保局會函請補正。",
      },
    ],
    links: [
  ...
  survivor: {
    ...
    steps: [
      ...
      {
        title: "查明過世者的投保年資",
        detail: "年資直接影響是否符合門檻與給付金額，可透過 MyData 調閱勞保投保資料。",
      },
      {
        title: "確認自己是否為適格請領人",
        detail: "依親屬順位認定，配偶、子女、父母等各有不同條件。",
      },
      {
        title: "填具申請書並檢附關係證明",
        detail: "需證明與過世者的親屬關係，戶籍資料可由 MyData 取得。",
      },
      {
        title: "送件並等待核定",
        detail: "核定後按月撥入指定帳戶，首次核發可能追溯自請領日。",
      },
    ],
    links: [
  ...
  special: {
    ...
    steps: [
      {
        title: "確認是否符合特殊境遇認定",
        detail: "須符合喪偶、離婚、家暴等法定情形之一。",
      },
      {
        title: "查明家庭收入與財產是否低於門檻",
        detail: "以全家人口平均分配計算。所得與財產資料可由 MyData 取得。",
      },
      {
        title: "向戶籍地公所社會課提出申請",
        detail: "各縣市受理窗口與應備文件略有差異，建議先電話確認。",
      },
      {
        title: "配合家庭訪視或資料補正",
        detail: "承辦人員可能進行訪視或要求補充說明。",
      },
      {
        title: "核定後按月或按次撥款",
        detail: "子女生活津貼通常按月核發，需定期重新審核。",
      },
    ],
    links: [
  ...
  unemploy: {
    ...
    steps: [
      {
        title: "向原雇主索取離職證明書",
        detail: "必須載明「非自願離職」字樣，這是最關鍵且無法由系統代取的文件。",
        isPrerequisite: true,
      },
      {
        title: "至公立就業服務機構辦理求職登記",
        detail: "須本人臨櫃，並填寫失業給付申請書及給付收據。",
      },
      {
        title: "接受就業推介或職訓安排",
        detail: "經 14 日內無法推介就業或安排職訓，才符合請領條件。",
      },
  ...
  relief: {
    ...
    steps: [
      {
        title: "準備致生急難的事由證明",
        detail: "例如死亡證明書、診斷證明書、非自願離職證明等。",
        isPrerequisite: true,
      },
      {
        title: "向公所社會課提出申請",
        detail: "可於戶籍地或實際居住地的公所辦理，不限戶籍地。",
      },
      {
        title: "配合訪視小組實地訪查",
        detail: "承辦人員會實地了解家庭狀況與急迫程度。",
      },
